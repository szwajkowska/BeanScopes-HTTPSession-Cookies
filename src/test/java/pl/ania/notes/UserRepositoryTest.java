...
import pl.ania.notes.program.UserRepository;
...
//        String user1 = "usesr1";
//        String user2 = "user2";
//        Note note1 = new Note(null, user1, username);
//        Note note11 = new Note(null, user1, username);
//        Note note2 = new Note(null, user2, username);
//        Note note22 = new Note(null, user2, username);
//        Note note222 = new Note(null, user2, username);
//        //when
